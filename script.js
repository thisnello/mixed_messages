...
const numMess = `Il tuo numero fortunato è: ${luckyNum}.`;
const jokeMess  = `Ecco una barzelletta per te:\n${randJoke}`;
const quoteMess = `Trova un po' di ispirazione con la seguente frase:\n${randQuote}`;

console.log(numMess, jokeMess, quoteMess);
